    ...
    listContainer.innerHTML = vehicles
      ...
      <div class="saved-vehicle-card" data-vehicle-id="${vehicle.id}">
        ...
        <div class="saved-vehicle-actions">
          <button
            class="saved-vehicle-action-icon saved-vehicle-action-select"
            onclick="useVehicleFromSavedList('${vehicle.id}')"
            data-tooltip="Select Vehicle"
          >
          ...
          <button
            class="saved-vehicle-action-icon saved-vehicle-action-edit"
          ...
          <button
            class="saved-vehicle-action-icon saved-vehicle-action-garage"
            onclick="addSavedVehicleToGarage('${vehicle.id}')"
            data-tooltip="Add to Garage"
          >
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            class="saved-vehicle-action-icon saved-vehicle-action-remove"
